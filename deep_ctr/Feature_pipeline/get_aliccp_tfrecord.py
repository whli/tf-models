...
# field_flg:feature_indexvalue
# input: 
# 40362692,0,0,216:9342395:1.0 301:9351665:1.0 205:7702673:1.0 206:8317829:1.0 207:8967741:1.0 508:9356012:2.30259 210:9059239:1.0 210:9042796:1.0 210:9076972:1.0 210:9103884:1.0 210:9063064:1.0 
...
def gen_tfrecords(in_file):
    ...
    with open(in_file) as fi:
        for line in fi:
            ...
            for f, (fname, def_id) in Ad_Fileds.iteritems():    # only have ids
                if f in ffv[:,0]:
                    mask = np.array(f == ffv[:,0])
                    feat_ids = ffv[mask,1]
                else:
