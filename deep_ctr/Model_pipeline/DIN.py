...
# for servering vs common fields 
tf.app.flags.DEFINE_integer("field_size", 0, "Number of fields")        # for_change common field size ??
...
def input_fn(filenames, batch_size=32, num_epochs=1, perform_shuffle=False):
    ...
    def _parse_fn(record):
        features = {
            ...
            "feat_ids": tf.FixedLenFeature([FLAGS.field_size], tf.int64),       # for_change common field size ??
